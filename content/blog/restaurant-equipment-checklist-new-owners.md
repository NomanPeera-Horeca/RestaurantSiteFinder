...
tags:
  ...
  - commercial kitchen
  - opening checklist
excerpt: "Under-buying refrigeration or overspending on cooking lines sinks openings. Use this room-by-room equipment checklist aligned to health codes, menu, and realistic 2026 pricing."
keywords:
  - restaurant equipment checklist
  - new restaurant kitchen equipment
  - commercial kitchen equipment list
  - restaurant opening equipment
...
faq:
  - question: "How much should new restaurant owners budget for equipment?"
    answer: "For a from-scratch kitchen, equipment and smallwares often run $150,000–$400,000 depending on size and concept, with fast casual toward the lower band and full service with bar toward the upper. Used equipment and leased hood spaces can reduce this 20–40%, but always budget installation, hood, and refrigeration separately."
  - question: "What restaurant equipment is required by health code?"
    answer: "At minimum: commercial refrigeration capable of holding cold foods at 41°F or below, hot holding as required by menu, three-compartment warewash or approved dishwasher, hand sinks separate from prep, mop sink, thermometers, and approved food-contact surfaces. Local codes add grease interceptors, backflow prevention, and ventilation tied to your hood class."
  - question: "Should I buy new or used restaurant equipment?"
    answer: "Buy new for refrigeration, ice machines, and anything under warranty-critical path. Consider certified used for ranges, ovens, and stainless tables if service history is documented. Never compromise on hood, fire suppression, or refrigeration capacity to save money—you pay on the health inspection line."
  - question: "When should I order restaurant equipment before opening?"
    answer: "Issue purchase orders as soon as kitchen layout is approved—lead times for walk-ins, hood fabrication, and custom fabrication often exceed 8–12 weeks. Sequence: hood and utilities first, refrigeration second, cooking line third, smallwares and POS last."
  - question: "What is the biggest equipment mistake new owners make?"
    answer: "Buying cooking capacity before confirming hood class, gas load, and refrigeration for the actual menu. Operators over-index on ranges and under-index on prep coolers, dry storage, and warewash—creating bottlenecks that show up as labor waste, not equipment gaps."
---

<div class="tldr-box"><p><strong>Key Takeaways</strong></p><ul><li>Build your equipment list from menu, volume, and layout—not from broker packages or auction lots.</li><li>Budget hood, <a href="/glossary/walk-in-cooler">walk-in cooler</a>, and <a href="/glossary/reach-in-refrigerator">reach-in refrigeration</a> as critical path items with long lead times.</li><li>Match cooking lines to realistic <a href="/glossary/covers">covers</a>; a <a href="/glossary/combi-oven">combi oven</a> can replace multiple pieces if your menu allows.</li><li>Source through specialists like <a href="https://www.thehorecastore.com/">Horeca Store</a> and validate your site with <a href="https://restaurantsitefinder.com/">Restaurant Site Finder</a> before locking lease TI dollars.</li></ul></div>

Equipment is where restaurant concepts become physical reality. New owners often treat the checklist as a shopping spree; experienced operators treat it as a capacity plan tied to sales, labor, and health code. The goal of this checklist is simple: nothing on the line should surprise you at inspection, and nothing in the back should fight your [mise en place](/glossary/mise-en-place) rhythm during a Friday rush.

Pair this guide with the [commercial kitchen equipment buying guide](/blog/commercial-kitchen-equipment-buying-guide), [opening cost breakdown for 2026](/blog/how-much-does-it-cost-to-open-a-restaurant-2026), and [site selection](/blog/how-to-choose-restaurant-location) so hood and utility assumptions match your building.
...
4. **Ovens** — Convection for pastries; [combi oven](/glossary/combi-oven) for proteins, retherm, and holding flexibility.
...
Buy throughput, not brand prestige. Two medium-efficiency fryers often beat one oversized unit when menu splits fried apps and mains. Explore lines at [Horeca Store commercial cooking equipment](https://www.thehorecastore.com/commercial-cooking-equipment).
...
Used walk-ins can work with new compressors and door gaskets documented. Never undersize evaporators to save rent—your [food cost percentage](/glossary/food-cost-percentage) rises when spoilage and emergency runs become routine. Browse [commercial refrigeration at Horeca Store](https://www.thehorecastore.com/commercial-refrigeration-equipment).

## Why Is the Hood System the Most Expensive Single Decision?

The [hood system](/glossary/hood-system) dictates what you may legally operate: fryer banks, charbroilers, and wok lines each carry different exhaust and fire suppression requirements. On second-generation spaces, verify:
...
Budget hood fabrication, installation, and make-up air as one project—splitting vendors creates finger-pointing at inspection. If your [location guide](/blog/how-to-choose-restaurant-location) flagged weak utilities, resolve gas and electrical upgrades before ordering cooking lines.
...
[Prime cost](/glossary/prime-cost) improves when prep is staged correctly the day before service, not when the line hunts pans during rush.
...
Integrate POS with inventory if you target tight [food cost percentage](/glossary/food-cost-percentage) control from day one.
...
Liquor liability and pour cost belong in your [business plan](/blog/how-to-write-restaurant-business-plan)—equipment is how you enforce recipes.
...
Delays on hood and walk-in cascade everything else. If you are weighing [ghost kitchen vs. traditional](/blog/ghost-kitchen-vs-traditional-restaurant) formats, equipment lists diverge early—commissary-heavy models may skip dining room ware entirely.

## How Does Equipment Spending Connect to Profitability?

Equipment is capex; it is not [prime cost](/glossary/prime-cost). But wrong equipment raises labor and waste forever. Model payoff:
...
Read [restaurant profit margins and unit economics](/blog/restaurant-profit-margins-unit-economics) to set sales targets that justify the line you buy.
