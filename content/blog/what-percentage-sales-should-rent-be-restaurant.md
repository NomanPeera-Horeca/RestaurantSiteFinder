...
metaTitle: "Optimal Restaurant Rent: Sales Percentage Guide"
slug: what-percentage-sales-should-rent-be-restaurant
metaDescription: "Discover the ideal rent-to-sales ratio for your restaurant. Learn how base rent at 6% and total occupancy costs below 10% of sales can support success."
date: "2026-09-16"
...
keywords:
  ...
  - restaurant rent percentage of sales
  - restaurant occupancy cost
  - rent to sales ratio restaurant
...
faq:
  - question: "What percentage of sales should restaurant rent be?"
    answer: "A common benchmark is base rent at about 6% of sales or less, with total occupancy cost (rent plus CAM, taxes, insurance, and other property charges) generally kept under about 10%. The right number depends on your concept, margins, market, and lease structure."
  - question: "What is included in restaurant occupancy cost?"
    answer: "Occupancy cost includes base rent plus common area maintenance (CAM), property tax pass-throughs, building insurance, and other required property-related charges. Some operators also factor in utilities tied to the premises and tenant maintenance obligations defined in the lease."
  - question: "How do you calculate rent as a percentage of sales?"
    answer: "Divide annual rent (or total occupancy cost) by annual gross sales, then multiply by 100. Use annual numbers rather than one strong or weak month, and stress-test with lower sales scenarios before signing."
  - question: "What is a percentage rent restaurant lease?"
    answer: "A percentage rent lease requires base rent plus an additional share of sales after reaching a negotiated breakpoint. The breakpoint, gross sales definition, exclusions, and payment timing all affect whether the structure is affordable."
  - question: "When is a restaurant lease too expensive?"
    answer: "If the lease only works under a best-case sales forecast, or if total occupancy cost exceeds roughly 10% of realistic sales while leaving too little room for food, labor, and profit, the site may be too expensive unless higher revenue is clearly achievable."
---

<div class="tldr-box"><p><strong>Key Takeaways</strong></p><ul><li><strong>Restaurant rent as a percentage of sales</strong> should usually target base rent around 6% or less, with total occupancy cost under about 10%, but the right number depends on your concept and margins.</li><li>Calculate the all-in occupancy cost, not just headline rent: CAM, taxes, insurance, and maintenance obligations can push a “cheap” lease over budget.</li><li>Model percentage rent breakpoints, annual increases, and conservative sales before signing.</li><li>Validate whether projected sales can support the lease with free analysis at <a href="https://restaurantsitefinder.com/">Restaurant Site Finder</a>.</li></ul></div>
...
A smart rent decision starts with the all-in number. If base rent is 6% of projected sales but total occupancy cost reaches 12% or 13%, the location may still be too expensive unless the site can reliably drive higher revenue. See [restaurant profit margins and unit economics](/blog/restaurant-profit-margins-unit-economics) for how occupancy fits into the full P&L.

![What percentage of sales should rent be for a restaurant, occupancy cost breakdown](/blog/what-percentage-sales-should-rent-be-restaurant/image1.webp)
...
1. **Estimate annual gross sales.** Be realistic. Use comparable locations, seat count, service style, hours, average check, and expected covers.
2. **Add annual base rent.** Multiply monthly base rent by 12.
3. **Add other occupancy charges.** Include CAM, taxes, insurance, and required property-related expenses if you want the true occupancy ratio.
4. **Divide by annual sales.** Annual rent or occupancy cost divided by annual gross sales gives the percentage.
5. **Stress-test the result.** Run the numbers again using lower sales, higher costs, and slower opening months.
...
The best site is not always the cheapest site. A higher-rent corner with visibility, parking, and strong foot traffic may outperform a low-rent space that customers never notice. Still, higher rent should be justified by a believable sales forecast, not wishful thinking. Use [Restaurant Site Finder](https://restaurantsitefinder.com/) to stress-test demand before you commit.
...
These details affect more than legal risk. They shape cash flow. A restaurant with manageable first-year rent but steep annual increases may cross from healthy to strained before the lease term is over. Read [how to find the right location for a restaurant](/blog/how-to-find-right-location-restaurant) for lease and site checks together.
...
If several boxes are uncertain, slow down. A restaurant lease is usually one of the largest fixed commitments in the business, and fixed costs are hardest to manage when sales dip. Pair this checklist with our [Go/No-Go location decision guide](/blog/go-no-go-restaurant-location-decision).
...
Run a free site analysis at [Restaurant Site Finder](https://restaurantsitefinder.com/) to validate demand before you sign, and review [restaurant startup costs](/blog/how-much-does-it-cost-to-open-a-restaurant-2026) for the full opening budget picture.
