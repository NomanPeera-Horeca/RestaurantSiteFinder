...
tags:
  ...
  - unit economics
  - investor pitch
excerpt: "A lender-ready restaurant business plan structure with the financial and operational depth banks, landlords, and partners expect—not a generic template."
keywords:
  - how to write a restaurant business plan
  - restaurant business plan template
  - restaurant startup plan
  - restaurant pro forma
  - restaurant investor deck
relatedSlugs:
  - restaurant-market-analysis-guide
  - how-much-does-it-cost-to-open-a-restaurant-2026
  - restaurant-profit-margins-unit-economics
faq:
  - question: "How long should a restaurant business plan be?"
    answer: "For bank or SBA submissions, 25–40 pages plus appendices is typical: 8–12 pages of narrative and 15–25 pages of financials, site data, and resumes. Investors may want a 10-page deck plus a detailed financial model in Excel."
  - question: "What financial projections do lenders require for restaurants?"
    answer: "Monthly year-one P&L, annual years two–three, sources and uses of funds, break-even analysis, debt service coverage, and sensitivity cases at 80% and 90% of sales forecast. Tie assumptions to covers, average check, and prime cost."
  - question: "Do I need a business plan for a small restaurant loan?"
    answer: "Yes—most lenders and landlords require one even for sub-$500K projects. It demonstrates you understand food cost, labor, and cash timing, not just recipes."
  - question: "What is the biggest mistake in restaurant business plans?"
    answer: "Unsubstantiated sales forecasts without trade-area data, competitor benchmarks, or daypart logic. Lenders discount plans that jump straight to 'year three profitability' without monthly seasonality."
  - question: "Should my business plan include equipment lists?"
    answer: "Include a summarized capital budget with major equipment categories and installation allowances. Detailed quotes belong in appendices; tie totals to your sources and uses table."
---

<div class="tldr-box">
<p><strong>Key Takeaways</strong></p>
<ul>
<li>A credible plan proves <strong>demand</strong> (market), <strong>delivery</strong> (operations), and <strong>survivability</strong> (cash flow)—in that order.</li>
<li>Build sales from <strong>covers × average check × dayparts</strong>, not top-down revenue guesses.</li>
<li>Anchor costs with <a href="/glossary/prime-cost">prime cost</a>, realistic <a href="/glossary/food-cost-percentage">food cost</a>, and <a href="/glossary/labor-cost-percentage">labor</a> targets by concept.</li>
<li>Match your <a href="/blog/how-much-does-it-cost-to-open-a-restaurant-2026">opening cost model</a> to sources and uses with 10–15% contingency.</li>
<li>Validate location with <a href="https://restaurantsitefinder.com/">Restaurant Site Finder</a> before you pitch lenders.</li>
</ul>
</div>
...
If you are simultaneously developing your [restaurant concept](/blog/restaurant-concept-development-guide), choosing a [location](/blog/how-to-choose-restaurant-location), and sourcing [commercial kitchen equipment](/blog/commercial-kitchen-equipment-buying-guide), treat the business plan as the integration layer that forces those workstreams to agree on one set of numbers.
...
Your plan must answer all five at some level—even if you only submit a subset externally. Internally, it is your pre-mortem: where does this concept break if lunch never materializes or if [food cost](/glossary/food-cost-percentage) runs 4 points high?
...
Cross-link your market chapter to a rigorous [restaurant market analysis](/blog/restaurant-market-analysis-guide) and your cost chapter to [profit margins and unit economics](/blog/restaurant-profit-margins-unit-economics) so assumptions stay consistent across documents.
...
3. **Market opportunity** — Gap you fill; cite third-party or [Restaurant Site Finder](https://restaurantsitefinder.com/) data where possible.
...
Run a free location report on [Restaurant Site Finder](https://restaurantsitefinder.com/) and paste summarized findings (competition density, demand score, demographic fit) into your appendix. It signals you did homework beyond Google Maps.

Tie competitive conclusions to your [concept development](/blog/restaurant-concept-development-guide): if the trade area is burger-saturated, your plan must explain why your smashburger wins share (speed, price, bar program, kids, etc.).

## What Belongs in the Operations Plan?

Operations is where plans fail credibility checks. Document:

**Service model** — Full service, fast casual, counter, [ghost kitchen](/glossary/ghost-kitchen), hybrid.

**Hours and staffing** — Open days, peak periods, FOH/BOH headcount by daypart, management coverage.

**Kitchen workflow** — Station map linked to [equipment plan](/blog/commercial-kitchen-equipment-buying-guide); prep vs cook vs finish; delivery handoff if applicable.
...
Show you understand [prime cost](/glossary/prime-cost) management operationally—not just on a spreadsheet. Example: "Weekly inventory on proteins; daily prep pars; labor scheduled to 15-minute increments on Fridays."
...
Align targets with our deep dive on [restaurant profit margins](/blog/restaurant-profit-margins-unit-economics). If your concept is delivery-heavy, model aggregator fees explicitly—they crush margin if hidden in "marketing."
...
Mirror your [opening cost guide](/blog/how-much-does-it-cost-to-open-a-restaurant-2026):
...
Reference your [permits and licenses roadmap](/blog/restaurant-permits-licenses-guide) with realistic timelines.
...
- Equipment budget summary and major quotes ([Horeca Store](https://www.thehorecastore.com/restaurant-equipment) or other vendors)
...
Draft section by section over two weeks, not in one heroic session. Validate location before you finalize sales: [Restaurant Site Finder](https://restaurantsitefinder.com/). Pressure-test food and labor with your chef and GM candidate. When equipment quotes land, update sources and uses the same day—stale numbers kill trust.

For equipment categories and rough capital bands to drop into your appendix, browse [Horeca Store restaurant equipment](https://www.thehorecastore.com/restaurant-equipment) or email **sales@thehorecastore.com** for budgetary pricing on cooking lines and refrigeration.
