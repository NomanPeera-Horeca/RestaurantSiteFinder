...
tags:
  ...
  - food cost
  - restaurant finance
excerpt: "Benchmarks and formulas for restaurant profit margins, prime cost control, and per-cover economics—so you know what 'good' looks like before opening day."
keywords:
  - restaurant profit margins
...
faq:
  - question: "What is a good profit margin for a restaurant?"
    answer: "Many independent full-service restaurants target 5–10% net profit at stabilization; fast-casual and well-run QSR can exceed 10–15%. EBITDA before central overhead often runs 12–18% for strong single units—concept and occupancy drive the spread."
  - question: "What is prime cost in a restaurant?"
    answer: "Prime cost is cost of goods sold (food and beverage) plus total labor (wages, taxes, benefits). It is the largest controllable expense block and is typically managed to 60–65% of sales for many full-service and fast-casual concepts."
  - question: "How do you calculate contribution margin per cover?"
    answer: "Subtract variable costs per guest (food, beverage, paper, merchant fees, delivery commissions, and variable labor) from average check. Fixed costs (rent, management salary base, insurance) are covered by aggregate contribution across covers."
  - question: "Why do restaurants fail on unit economics despite busy dining rooms?"
    answer: "High occupancy with weak average check, discounting, delivery aggregator fees, overtime labor, and occupancy above 10% of sales can produce revenue without profit. Busy is not the same as profitable."
  - question: "How often should operators review margin metrics?"
    answer: "Daily sales and labor; weekly food cost and waste; monthly full P&L and menu mix. Quarterly menu engineering and price tests keep margins aligned with commodity inflation."
---

<div class="tldr-box">
<p><strong>Key Takeaways</strong></p>
<ul>
<li><a href="/glossary/prime-cost">Prime cost</a> (COGS + labor) is the primary lever—target bands matter more than industry averages alone.</li>
<li>Model <strong>contribution margin per cover</strong> before you sign a lease with rent above 8% of projected sales.</li>
<li>Delivery and discounting can add revenue while <strong>destroying margin</strong>—track channel P&L separately.</li>
<li>Align menu price, portion, and prep with <a href="/glossary/food-cost-percentage">food cost %</a> and <a href="/glossary/labor-cost-percentage">labor %</a> weekly.</li>
<li>Validate demand with <a href="https://restaurantsitefinder.com/">Restaurant Site Finder</a> so volume assumptions in your pro forma are realistic.</li>
</ul>
</div>

Restaurant profit margins are among the most misunderstood numbers in hospitality. A full dining room can still produce a losing month if your [prime cost](/glossary/prime-cost) is out of band, your rent was underwritten on fantasy covers, or third-party delivery fees silently eat ten points of margin. Unit economics—the profit physics of a single location—turns revenue into a language operators can manage daily: dollars per cover, contribution after variable costs, and cash left after debt service.

This guide explains how restaurant profit margins are built, what benchmarks mean (and when to ignore them), and how to connect margin management to decisions you are already making on [location](/blog/how-to-choose-restaurant-location), [menu/concept](/blog/restaurant-concept-development-guide), [equipment](/blog/commercial-kitchen-equipment-buying-guide), and your [business plan](/blog/how-to-write-restaurant-business-plan).
...
**Prime cost** combines [food cost percentage](/glossary/food-cost-percentage) and [labor cost percentage](/glossary/labor-cost-percentage)—the dashboard most GMs live on weekly.
...
If your [market analysis](/blog/restaurant-market-analysis-guide) supports 4,000 covers/month but break-even requires 5,200, you do not have a marketing problem—you have a site or concept problem. Run trade-area validation on [Restaurant Site Finder](https://restaurantsitefinder.com/) before you renegotiate rent or rebuild the menu.
...
Occupancy (rent + CAM) above **8–10% of sales** compresses net margin even when prime cost looks healthy. That is why unit economics starts at [location selection](/blog/how-to-choose-restaurant-location), not in the back office.
...
Pair engineering with equipment that reduces waste—[combi ovens](/glossary/combi-oven) for consistent yields, [blast chillers](/glossary/blast-chiller) for safe hold times on prepped proteins. Capital spent on [Horeca Store cooking equipment](https://www.thehorecastore.com/commercial-cooking-equipment) should tie to items with high contribution, not vanity stations.
...
Overtime is a margin leak; so is understaffing (guest churn, remakes, bad reviews). Your [business plan](/blog/how-to-write-restaurant-business-plan) should document labor standards the GM will actually run.

## How Should You Tie Margins to Opening and Growth Capital?

Undercapitalized openings destroy margin through emergency purchasing, premium labor agencies, and deferred maintenance. Your [opening cost model](/blog/how-much-does-it-cost-to-open-a-restaurant-2026) should include working capital for **90 days of variability**—not just opening week.

Equipment financed over long terms lowers cash burn but adds debt service; model both EBITDA and cash after debt. Right-size the kitchen to avoid excess [prime cost](/glossary/prime-cost) from depreciation, cleaning, and complexity—see our [equipment buying guide](/blog/commercial-kitchen-equipment-buying-guide).
...
Before you commit, compare competitor density, income fit, and demand scores using [Restaurant Site Finder](https://restaurantsitefinder.com/). Margin management is easier when the trade area meets your concept on day one.
...
For equipment that supports consistent yields and labor-efficient prep, explore [Horeca Store restaurant equipment](https://www.thehorecastore.com/restaurant-equipment) or call **866.446.7322**. For demand proof that backs your sales forecast, analyze your site free at [Restaurant Site Finder](https://restaurantsitefinder.com/).
