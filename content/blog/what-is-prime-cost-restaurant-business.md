...
metaTitle: "Master Prime Cost: Essential Guide for Restaurant Success"
slug: what-is-prime-cost-restaurant-business
metaDescription: >-
  Discover what prime cost is in the restaurant business and how it influences profitability. Learn the prime cost formula for effective food cost management and labor control.
date: "2026-08-26"
...
keywords:
  - what is prime cost in restaurant business
  - prime cost formula restaurant
  - master prime cost restaurant
  - food cost management prime cost
  - restaurant labor and COGS
relatedSlugs:
...
faq:
  - question: "What is prime cost in restaurant business?"
    answer: "Prime cost combines cost of goods sold (food and beverage used) with total labor cost—the two largest controllable expenses. It shows whether daily sales are turning into sustainable profit or being absorbed by operations."
  - question: "What is the prime cost formula?"
    answer: "Prime cost = cost of goods sold + total labor cost. COGS is typically beginning inventory plus purchases minus ending inventory for the same period. Compare the dollar total and the percentage of sales for trend tracking."
  - question: "What should be included in prime cost?"
    answer: "Include product costs for ingredients and beverages actually used, plus labor for kitchen, front-of-house, and management. Some operators also include payroll taxes and benefits—what matters most is applying the same definition every reporting period."
  - question: "What is a good prime cost percentage?"
    answer: "Many full-service and fast-casual restaurants plan around 60–65% of sales, though bars, QSR, and fine dining can differ. Use your concept's target band consistently and review weekly—not only at month-end."
  - question: "How often should restaurants track prime cost?"
    answer: "Weekly or period-based reviews give managers time to adjust scheduling, purchasing, and menu pricing before small leaks become expensive patterns. Pair counts, invoice review, and labor variance in the same rhythm."
---

<div class="tldr-box"><p><strong>Key Takeaways</strong></p><ul><li><strong>Prime cost</strong> = COGS + total labor—the clearest signal for whether sales are converting to margin or being eaten by operations.</li><li>Use the same formula every period: count inventory, capture labor for matching dates, and compare dollars and percentage of sales.</li><li>Balance food cost management and labor planning—cutting one expense in isolation often damages guest experience and repeat business.</li><li>Model prime cost in your <a href="/blog/how-to-write-restaurant-business-plan">business plan</a> and validate location economics free at <a href="https://restaurantsitefinder.com/">Restaurant Site Finder</a> before you sign a lease.</li></ul></div>
...
![Prime cost in restaurant business—COGS plus labor as the core profitability metric](/blog/what-is-prime-cost-restaurant-business/image1.webp)
...
The goal is not to make every dish cheaper. The goal is to protect the guest experience while making sure the restaurant is paid fairly for what it serves. Track [food cost percentage](/glossary/food-cost-percentage) alongside prime cost for sharper diagnostics.
...
- Measure service quality along with [labor cost percentage](/glossary/labor-cost-percentage), not separately from it.
...
The best place to start is simple: choose your reporting period, define what you include, count inventory consistently, collect labor costs for the same dates, and apply the prime cost formula the same way every time. From there, use the result as a guide for better questions and better decisions. For target bands and margin context, read [restaurant profit margins and unit economics](/blog/restaurant-profit-margins-unit-economics).
